...
function UpdateDish(props) {
    ...
    return (
        <div className="updateDishPage">
            <div className="header">
                <div className="title" >{props.dish.name}</div>
                <div className="back" onClick={props.routeDish}></div>
            </div>

            <div className="body">
                <div className={classNames("imageFood")}>
                    {
                        croppedImage != null ? <img src={croppedImage} alt="food"/> :
                        <img src={uri} alt="food"/>
                    }
                ...
                >
                    {
                        getValues("category") !== undefined && getValues("category") !== "" && categoryList.length > 0 ? 
                ...
                <input 
                    type="number" 
                    className="hiddenInput"
                    defaultValue={props.dish.categoryId}
                ...
                <div className={classNames("status")}>
                    <div className="myStatus">
                        ...
                        <input 
                                type="checkbox" 
                                defaultChecked={props.dish.dishStatusId == 1} 
                                {...register("status")}
                            />
            ...
            <div className="footer">
                ...
                <div className="okie button" onClick={handleSubmit(onSubmit)}>Cập nhật</div>
            </div>
        </div>
    )
}
